...
live2d_settings['tipsMessage']          = 'mytip.json';            // 同目录下可省略路径
...
live2d_settings['aboutPageUrl']         = 'https://live2d.fghrsh.net/';   // 关于页地址, '{URL 网址}'
...
function loadTipsMessage(result) {
    ...
    $.each(result.mouseover, function (index, tips){
        $(document).on("mouseover", tips.selector, function (){
            var text = getRandText(tips.text).replaceAll('{title}',$(this).text());
